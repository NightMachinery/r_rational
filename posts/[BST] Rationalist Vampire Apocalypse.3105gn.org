...
Another option for the protagonist to go for if they really do feel humans are cattle, make cattle. Abduct the homeless and orphans, and move them to a secure place to be bred. This means you have an observed food source that you can blood test prefeeding and you can take a child at any time to raise as the protagonist was if you need more vamps in the case vamps are sterile.
:PROPERTIES:
:Author: Topher876
:Score: 2
