#+TITLE: [RT][HF][WIP][Rom] Vampire Flower Language - Michaelmas Daisy (or: the definition of personhood gets a look in, someone with alien values tries to do some manipulation, and it's just generally sad)
